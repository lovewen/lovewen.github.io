...
var photoFlyToHert = function(photoType) {
	...
	//将相册移动到指巨型心心顶点
	let x = bigHert.children[0].geometry.attributes.position.getX(index);
	let y = bigHert.children[0].geometry.attributes.position.getY(index);
	let z = bigHert.children[0].geometry.attributes.position.getZ(index);
	let xn = bigHert.children[0].geometry.attributes.position.getX(index) + x;
	let yn = bigHert.children[0].geometry.attributes.position.getY(index) + y;
	let zn = bigHert.children[0].geometry.attributes.position.getZ(index) + z;
